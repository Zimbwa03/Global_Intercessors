...
DECLARE
  test_result RECORD;
BEGIN
  -- Test the get_all_skip_requests_admin function
  FOR test_result IN SELECT * FROM get_all_skip_requests_admin() LIMIT 1 LOOP
    RAISE NOTICE 'get_all_skip_requests_admin function is working correctly';
  END LOOP;
  
  RAISE NOTICE 'Skip request admin functions have been successfully created and tested';
END
$$;
